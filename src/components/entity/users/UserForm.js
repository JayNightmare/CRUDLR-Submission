...
import { defaultUser, levels, register, type } from '../../../utils/shared/defaults.js';
...
const UserForm = ({ ogUser, onSubmit, onCancel }) => {
    ...
    return (
        <Form onSubmit={handleSubmit} onCancel={onCancel} submitLabel={submitLabel} submitIcon={submitIcon}>
            ...
            <Form.InputText label="User's First Name" value={user.UserFirstname} onChange={(value) => handleChange('UserFirstname', value)} />
            <Form.InputText label="User's Last Name" value={user.UserLastname} onChange={(value) => handleChange('UserLastname', value)} />
            ...
            <Form.InputSelect label="User Type" prompt="Select Registered Value" options={type} value={user.UserUsertypeName} onChange={(value) => handleChange('UserUsertypeName', value)} />
